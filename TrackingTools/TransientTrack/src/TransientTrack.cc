...
TransientTrack::TransientTrack(const TrackRef& tk,
    ...
    : Base(new TTT(tk, time, dtime, field, tg, trkAssoc, mtdtime, mtdtimeErr, mva, pathlength, btlchi2, btltimechi2, etlchi2, etltimechi2, time_pi, time_k, time_p, sigma_time_pi, sigma_time_k, sigma_time_p)) {}
